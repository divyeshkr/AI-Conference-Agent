...
require_access()
st.markdown(
    "<style>.ci-chip-mock{background:#fde2e2;color:#a11;}</style>",
...
m3.metric("Placeholder cards", sum(1 for c in filtered if c.is_mock))
...
for card in filtered:
    ...
    if card.is_mock:
        chips += '<span class="ci-chip ci-chip-mock">🧪 MOCK — NOT FROM YOUR FILE</span>'
